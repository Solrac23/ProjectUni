...
# teste inserção
lista.push('Profa Jéssica', 0)  # inserção no início
lista.show()
lista.push('Pedro', 1)  # inserção no final
lista.show()
lista.push('Karina', 0)  # inserção no início
lista.show()
lista.push('Luana', 2)  # inserção no meio
lista.show()
lista.push('Lucy', 4)  # inserção no final
lista.show()
lista.push('Alex', 2)  # inserção no meio
lista.show()
